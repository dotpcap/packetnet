...
#pragma warning restore 0169, 0649
        ...
        {
            get => (LinkLayers)EndianBitConverter.Big.ToUInt16(this.HeaderByteArraySegment.Bytes, this.HeaderByteArraySegment.Offset + ARPFields.HardwareAddressTypePosition);

            set
            {
                var theValue = (UInt16)value;
                EndianBitConverter.Big.CopyBytes(theValue, this.HeaderByteArraySegment.Bytes, this.HeaderByteArraySegment.Offset + ARPFields.HardwareAddressTypePosition);
            }
        }
        ...
        {
            get => (EthernetPacketType)EndianBitConverter.Big.ToUInt16(this.HeaderByteArraySegment.Bytes, this.HeaderByteArraySegment.Offset + ARPFields.ProtocolAddressTypePosition);

            set
            {
                var theValue = (UInt16)value;
                EndianBitConverter.Big.CopyBytes(theValue, this.HeaderByteArraySegment.Bytes, this.HeaderByteArraySegment.Offset + ARPFields.ProtocolAddressTypePosition);
            }
        }
        ...
        {
            get => this.HeaderByteArraySegment.Bytes[this.HeaderByteArraySegment.Offset + ARPFields.HardwareAddressLengthPosition];

            set => this.HeaderByteArraySegment.Bytes[this.HeaderByteArraySegment.Offset + ARPFields.HardwareAddressLengthPosition] = (Byte)value;
        }
        ...
        {
            get => this.HeaderByteArraySegment.Bytes[this.HeaderByteArraySegment.Offset + ARPFields.ProtocolAddressLengthPosition];

            set => this.HeaderByteArraySegment.Bytes[this.HeaderByteArraySegment.Offset + ARPFields.ProtocolAddressLengthPosition] = (Byte)value;
        }
        ...
        {
            get => (ARPOperation)EndianBitConverter.Big.ToInt16(this.HeaderByteArraySegment.Bytes, this.HeaderByteArraySegment.Offset + ARPFields.OperationPosition);

            set
            {
                var theValue = (Int16)value;
                EndianBitConverter.Big.CopyBytes(theValue, this.HeaderByteArraySegment.Bytes, this.HeaderByteArraySegment.Offset + ARPFields.OperationPosition);
            }
        }
        ...
        {
            get => IpPacket.GetIPAddress(System.Net.Sockets.AddressFamily.InterNetwork, this.HeaderByteArraySegment.Offset + ARPFields.SenderProtocolAddressPosition, this.HeaderByteArraySegment.Bytes);
            ...
            set
            {
                ...
                Array.Copy((Array) address, (Int32) 0,
                           (Array) this.HeaderByteArraySegment.Bytes, (Int32) (this.HeaderByteArraySegment.Offset + ARPFields.SenderProtocolAddressPosition),
                           address.Length);
            }
        }
        ...
        {
            get => IpPacket.GetIPAddress(System.Net.Sockets.AddressFamily.InterNetwork, this.HeaderByteArraySegment.Offset + ARPFields.TargetProtocolAddressPosition, this.HeaderByteArraySegment.Bytes);
            ...
            set
            {
                ...
                Byte[] address = value.GetAddressBytes();
                Array.Copy((Array) address, (Int32) 0,
                           (Array) this.HeaderByteArraySegment.Bytes, (Int32) (this.HeaderByteArraySegment.Offset + ARPFields.TargetProtocolAddressPosition),
                           address.Length);
            }
        }
        ...
        public virtual PhysicalAddress SenderHardwareAddress
        {
            get
            {
                ...
                Array.Copy((Array) this.HeaderByteArraySegment.Bytes, (Int32) (this.HeaderByteArraySegment.Offset + ARPFields.SenderHardwareAddressPosition),
            ...
            set
            {
                ...
                Array.Copy((Array) hwAddress, (Int32) 0,
                           (Array) this.HeaderByteArraySegment.Bytes, (Int32) (this.HeaderByteArraySegment.Offset + ARPFields.SenderHardwareAddressPosition),
                           hwAddress.Length);
            }
        }
        ...
        public virtual PhysicalAddress TargetHardwareAddress
        {
            get
            {
                ...
                // a fixed position
                Byte[] hwAddress = new Byte[this.HardwareAddressLength];
                Array.Copy((Array) this.HeaderByteArraySegment.Bytes, (Int32) (this.HeaderByteArraySegment.Offset + ARPFields.TargetHardwareAddressPosition),
                           hwAddress, 0,
                           hwAddress.Length);
                return new PhysicalAddress(hwAddress);
            }
            set
            {
                ...
                Array.Copy((Array) hwAddress, (Int32) 0,
                           (Array) this.HeaderByteArraySegment.Bytes, (Int32) (this.HeaderByteArraySegment.Offset + ARPFields.TargetHardwareAddressPosition),
                           hwAddress.Length);
            }
        }
        ...
        public override String ToString(StringOutputType outputFormat)
        {
            ...
            if(outputFormat == StringOutputType.Verbose || outputFormat == StringOutputType.VerboseColored)
            {
                ...
                {
                    { "hardware type", this.HardwareAddressType.ToString() + " (0x" + this.HardwareAddressType.ToString("x") + ")" },
                    { "protocol type", this.ProtocolAddressType.ToString() + " (0x" + this.ProtocolAddressType.ToString("x") + ")" },
                    { "operation", this.Operation.ToString() + " (0x" + this.Operation.ToString("x") + ")" },
