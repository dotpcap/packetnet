...
#pragma warning restore 1591
        ...
        public override System.Net.IPAddress SourceAddress
        {
            ...
            set
            {
                ...
                Array.Copy((Array) address, (int) 0,
                           (Array) header.Bytes, (int) (header.Offset + IPv4Fields.SourcePosition),
                           address.Length);
            }
        }
        ...
        public override System.Net.IPAddress DestinationAddress
        {
            ...
            set
            {
                byte[] address = value.GetAddressBytes();
                Array.Copy((Array) address, (int) 0,
                           (Array) header.Bytes, (int) (header.Offset + IPv4Fields.DestinationPosition),
                           address.Length);
            }
        }
        ...
        internal override byte[] AttachPseudoIPHeader(byte[] origHeader)
        {
            ...
            Array.Copy((Array) header.Bytes,
                       (int) (header.Offset + IPv4Fields.SourcePosition),
                       headerForChecksum,
                       0,
        ...
        public override string ToString(StringOutputType outputFormat)
        {
            ...
            if(outputFormat == StringOutputType.Verbose || outputFormat == StringOutputType.VerboseColored)
            {
                ...
                string diffServices =  Convert.ToString((int) DifferentiatedServices, 2).PadLeft(8, '0').Insert(4, " ");
                ...
                string flags = Convert.ToString((int) FragmentFlags, 2).PadLeft(8, '0').Substring(5, 3);
