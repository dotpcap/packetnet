...
namespace PacketDotNet.Ieee80211
{
    ...
    public class AssociationRequestFrame : ManagementFrame
    {
        ...
        private UInt16 CapabilityInformationBytes
        {
            get
            {
                if (this.HeaderByteArraySegment.Length >=
                    (AssociationRequestFields.CapabilityInformationPosition +
                     AssociationRequestFields.CapabilityInformationLength))
                {
                    return EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                        this.HeaderByteArraySegment.Offset + AssociationRequestFields.CapabilityInformationPosition);
                }
        ...
        private UInt16 ListenIntervalBytes
        {
            ...
            {
                if (this.HeaderByteArraySegment.Length >=
                    (AssociationRequestFields.ListenIntervalPosition + AssociationRequestFields.ListenIntervalLength))
                {
                    return EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                        this.HeaderByteArraySegment.Offset + AssociationRequestFields.ListenIntervalPosition);
                }
        ...
        public override void UpdateCalculatedValues()
        {
            ...
            this.InformationElements.CopyTo(this.HeaderByteArraySegment,
                this.HeaderByteArraySegment.Offset + AssociationRequestFields.InformationElement1Position);
