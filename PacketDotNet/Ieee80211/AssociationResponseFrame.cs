...
namespace PacketDotNet.Ieee80211
{
    ...
    public class AssociationResponseFrame : ManagementFrame
    {
        ...
        private UInt16 AssociationIdBytes
        {
            get
            {
                if (this.HeaderByteArraySegment.Length >= AssociationResponseFields.AssociationIdPosition +
                    AssociationResponseFields.AssociationIdLength)
                {
                    UInt16 associationID = EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                        this.HeaderByteArraySegment.Offset + AssociationResponseFields.AssociationIdPosition);
            ...
            set
            {
                ...
                EndianBitConverter.Little.CopyBytes(associationID, this.HeaderByteArraySegment.Bytes,
                    this.HeaderByteArraySegment.Offset + AssociationResponseFields.AssociationIdPosition);
            }
        }
        ...
        private UInt16 CapabilityInformationBytes
        {
            get
            {
                if (this.HeaderByteArraySegment.Length >=
                    (AssociationResponseFields.CapabilityInformationPosition +
                     AssociationResponseFields.CapabilityInformationLength))
                {
                    return EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                        this.HeaderByteArraySegment.Offset + AssociationResponseFields.CapabilityInformationPosition);
                }
        ...
        private AuthenticationStatusCode StatusCodeBytes
        {
            ...
            {
                if (this.HeaderByteArraySegment.Length >=
                    (AssociationResponseFields.StatusCodePosition + AssociationResponseFields.StatusCodeLength))
                {
                    return (AuthenticationStatusCode) EndianBitConverter.Little.ToUInt16(
                        this.HeaderByteArraySegment.Bytes,
                        this.HeaderByteArraySegment.Offset + AssociationResponseFields.StatusCodePosition);
                }
        ...
        public override void UpdateCalculatedValues()
        {
            ...
            this.InformationElements.CopyTo(this.HeaderByteArraySegment,
                this.HeaderByteArraySegment.Offset + AssociationResponseFields.InformationElement1Position);
