...
namespace PacketDotNet.Ieee80211
{
    ...
    public abstract class DataFrame : MacFrame
    {
        ...
        protected UInt16 SequenceControlBytes
        {
            get
            {
                if (this.HeaderByteArraySegment.Length >=
                    (MacFields.SequenceControlPosition + MacFields.SequenceControlLength))
                {
                    return EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                        (this.HeaderByteArraySegment.Offset + MacFields.Address1Position +
        ...
        protected override String GetAddressString()
        {
            ...
            {
                addresses =
                    $"SA {this.SourceAddress} DA {this.DestinationAddress} TA {this.TransmitterAddress} RA {this.ReceiverAddress}";
            }
            else
            {
