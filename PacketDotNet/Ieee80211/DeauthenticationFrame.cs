        ...
        private ReasonCode ReasonBytes
        {
            get
            {
                if (this.HeaderByteArraySegment.Length >=
                    (DeauthenticationFields.ReasonCodePosition + DeauthenticationFields.ReasonCodeLength))
                {
                    return (ReasonCode) EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                        this.HeaderByteArraySegment.Offset + DeauthenticationFields.ReasonCodePosition);
                }
