...
namespace PacketDotNet.Ieee80211
{
    ...
    public class PpiPacket : InternetLinkLayerPacket, IEnumerable
    {
        ...
        {
            get => EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                this.HeaderByteArraySegment.Offset + PpiHeaderFields.LengthPosition);
        ...
        private Byte VersionBytes
        {
            get => this.HeaderByteArraySegment.Bytes[
                this.HeaderByteArraySegment.Offset + PpiHeaderFields.VersionPosition];

            set => this.HeaderByteArraySegment.Bytes[
                this.HeaderByteArraySegment.Offset + PpiHeaderFields.VersionPosition] = value;
        }
        ...
        {
            get => (HeaderFlags) this.HeaderByteArraySegment.Bytes[
                this.HeaderByteArraySegment.Offset + PpiHeaderFields.FlagsPosition];

            set =>
                this.HeaderByteArraySegment.Bytes[this.HeaderByteArraySegment.Offset + PpiHeaderFields.FlagsPosition] =
                    (Byte) value;
        }
        ...
        {
            get => (LinkLayers) EndianBitConverter.Little.ToUInt32(this.HeaderByteArraySegment.Bytes,
                this.HeaderByteArraySegment.Offset + PpiHeaderFields.DataLinkTypePosition);

            set => EndianBitConverter.Little.CopyBytes((UInt32) this.LinkType, this.HeaderByteArraySegment.Bytes,
                this.HeaderByteArraySegment.Offset + PpiHeaderFields.DataLinkTypePosition);
        }
        ...
        public override void UpdateCalculatedValues()
        {
            ...
            MemoryStream ms = new MemoryStream(this.HeaderByteArraySegment.Bytes,
                this.HeaderByteArraySegment.Offset + PpiHeaderFields.FirstFieldPosition,
        ...
        private List<PpiField> ReadPpiFields()
        {
            ...
            var br = new BinaryReader(new MemoryStream(this.HeaderByteArraySegment.Bytes,
                offset,
                this.HeaderByteArraySegment.Length - offset));
            Int32 type = 0;
        ...
        internal static PacketOrByteArraySegment ParseEncapsulatedBytes(ByteArraySegment header, PpiCommon commonField)
        {
            ...
            if (commonField != null)
            {
                Boolean fcsPresent = ((commonField.Flags & PpiCommon.CommonFlags.FcsIncludedInFrame) ==
