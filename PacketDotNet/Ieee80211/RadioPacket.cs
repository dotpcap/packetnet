...
#pragma warning restore 0169, 0649
        ...
        private Byte VersionBytes
        {
            ...
            set => this.HeaderByteArraySegment.Bytes[this.HeaderByteArraySegment.Offset + RadioFields.VersionPosition] =
                value;
        }
        ...
        private UInt16 LengthBytes
        {
            get => EndianBitConverter.Little.ToUInt16(this.HeaderByteArraySegment.Bytes,
                this.HeaderByteArraySegment.Offset + RadioFields.LengthPosition);
        ...
        private UInt32[] ReadPresentFields()
        {
            ...
            UInt32 bitmask = EndianBitConverter.Little.ToUInt32(this.HeaderByteArraySegment.Bytes,
                this.HeaderByteArraySegment.Offset + RadioFields.PresentPosition);
            bitmaskFields.Add(bitmask);
            Int32 bitmaskOffsetInBytes = 4;
            while ((bitmask & (1 << 31)) == 1)
            {
                // retrieve the next field
                bitmask = EndianBitConverter.Little.ToUInt32(this.HeaderByteArraySegment.Bytes,
                    this.HeaderByteArraySegment.Offset + RadioFields.PresentPosition + bitmaskOffsetInBytes);
                bitmaskFields.Add(bitmask);
        ...
        internal RadioPacket(ByteArraySegment bas)
        {
            ...
            this.PayloadPacketOrData =
                ParseEncapsulatedBytes(this.HeaderByteArraySegment.EncapsulatedBytes(), flagsField);
        }
        ...
        public override void UpdateCalculatedValues()
        {
            ...
            {
                EndianBitConverter.Little.CopyBytes(presentField, this.HeaderByteArraySegment.Bytes,
                    this.HeaderByteArraySegment.Offset + index);
            ...
            {
                Array.Copy(this.UnhandledFieldBytes, 0, this.HeaderByteArraySegment.Bytes,
                    this.HeaderByteArraySegment.Offset + index, this.UnhandledFieldBytes.Length);
            }
        }

        internal static PacketOrByteArraySegment ParseEncapsulatedBytes(ByteArraySegment payload,
            FlagsRadioTapField flagsField)
        {
            ...
            if (flagsField != null)
            {
                Boolean fcsPresent = ((flagsField.Flags & RadioTapFlags.FcsIncludedInFrame) ==
                                      RadioTapFlags.FcsIncludedInFrame);
