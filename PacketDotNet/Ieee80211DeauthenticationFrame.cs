...
{
    public class Ieee80211DeauthenticationFrame : Ieee80211ManagementFrame
    {
        private class Ieee80211DeauthenticationFields
        {
            public readonly static int ReasonCodeLength = 2;

            public readonly static int ReasonCodePosition;

            static Ieee80211DeauthenticationFields()
            {
        ...
        public Ieee80211ReasonCode Reason
        {
            get
            {
                return (Ieee80211ReasonCode)EndianBitConverter.Little.ToUInt16(header.Bytes,
                    header.Offset + Ieee80211DeauthenticationFields.ReasonCodePosition);
            }
        }
        ...
        public override int FrameSize
        {
            get
            {
                return (Ieee80211MacFields.FrameControlLength +
                    ...
                    Ieee80211DeauthenticationFields.ReasonCodeLength);
            }
        }
        ...
        /// </param>
        public Ieee80211DeauthenticationFrame(ByteArraySegment bas)
        {
