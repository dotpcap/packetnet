...
#pragma warning restore 0169, 0649
        ...
        {
            get => EndianBitConverter.Big.ToUInt16(this._byteArraySegment.Bytes, this._byteArraySegment.Offset);

            set => EndianBitConverter.Big.CopyBytes(value, this._byteArraySegment.Bytes, this._byteArraySegment.Offset);
        }
    }
}