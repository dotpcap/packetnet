    ...
    public class LSA
    {
        ...
        public IPAddress AdvertisingRouter
        {
            get
            {
                var val = EndianBitConverter.Little.ToUInt32(this.Header.Bytes,
                    this.Header.Offset + LSAFields.AdvertisingRouterIDPosition);
        ...
        public UInt16 Checksum
        {
            ...
            set => EndianBitConverter.Big.CopyBytes(value, this.Header.Bytes,
                this.Header.Offset + LSAFields.ChecksumPosition);
        }
        ...
        public UInt16 Length
        {
            get => EndianBitConverter.Big.ToUInt16(this.Header.Bytes,
                this.Header.Offset + LSAFields.PacketLengthPosition);
            set => EndianBitConverter.Big.CopyBytes(value, this.Header.Bytes,
                this.Header.Offset + LSAFields.PacketLengthPosition);
        }
        ...
        public IPAddress LinkStateID
        {
            ...
            {
                var val = EndianBitConverter.Little.ToUInt32(this.Header.Bytes,
                    this.Header.Offset + LSAFields.LinkStateIDPosition);
                return new IPAddress(val);
            }
            set
            {
        ...
        public UInt16 LSAge
        {
            ...
            set => EndianBitConverter.Big.CopyBytes(value, this.Header.Bytes,
                this.Header.Offset + LSAFields.LSAgePosition);
        }
        ...
        public UInt32 LSSequenceNumber
        {
            get => EndianBitConverter.Big.ToUInt32(this.Header.Bytes,
                this.Header.Offset + LSAFields.LSSequenceNumberPosition);
            set => EndianBitConverter.Big.CopyBytes(value, this.Header.Bytes,
                this.Header.Offset + LSAFields.LSSequenceNumberPosition);
        }
