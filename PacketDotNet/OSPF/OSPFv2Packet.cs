...
#pragma warning restore 0169
        ...
        public override string ToString()
        {
            ...
            packet.AppendFormat((string) "OSPFv2 packet, type {0} ", (object) this.Type);
            packet.AppendFormat((string) "length: {0}, ", (object) this.PacketLength);
            packet.AppendFormat((string) "Checksum: {0:X8}, ", (object) this.Checksum);
