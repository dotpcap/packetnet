    ...
    public class OSPFv2HelloPacket : OSPFv2Packet
    {
        ...
        public virtual System.Net.IPAddress NetworkMask
        {
            ...
            set
            {
                ...
                Array.Copy(address, 0,
                    this.header.Bytes, this.header.Offset + OSPFv2Fields.NetworkMaskPositon,
                    address.Length);
            }
        }
        ...
        public virtual System.Net.IPAddress DesignatedRouterID
        {
            ...
            set
            {
                byte[] address = value.GetAddressBytes();
                Array.Copy(address, 0,
                    this.header.Bytes, this.header.Offset + OSPFv2Fields.DesignatedRouterIDPosition,
                    address.Length);
            }
        }
        ...
        public virtual System.Net.IPAddress BackupRouterID
        {
            ...
            set
            {
                byte[] address = value.GetAddressBytes();
                Array.Copy(address, 0,
                    this.header.Bytes, this.header.Offset + OSPFv2Fields.BackupRouterIDPosition,
                    address.Length);
            }
        }
