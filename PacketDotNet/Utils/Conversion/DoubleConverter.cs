...
namespace PacketDotNet.Utils.Conversion
{
    ...
    public class DoubleConverter
    {
        ...
        private class ArbitraryDecimal
        {
            ...
            {
                Byte[] result = new Byte[this._digits.Length+1];
                for (Int32 i=this._digits.Length-1; i >= 0; i--)
                {
                    Int32 resultDigit = this._digits[i]*amount+result[i+1];
            ...
            {
                Char[] digitString = new Char[this._digits.Length];
                for (Int32 i=0; i < this._digits.Length; i++)
                ...
                {
                    return new String (digitString)+
                        new String ('0', -this._decimalPoint);
                }
                ...
                {
                    return "0."+
                        new String ('0',(this._decimalPoint-digitString.Length))+
                ...
                return new String (digitString, 0,
                    digitString.Length-this._decimalPoint)+
                    "."+
                    new String (digitString,
                    digitString.Length-this._decimalPoint,
                    this._decimalPoint);
