...
namespace Test.PacketType
{
    namespace Ieee80211
    {
        ...
        public class BlockAcknowledgmentRequestFrameTest
        {
            ...
            {
                var dev = new CaptureFileReaderDevice(
                    "../../CaptureFiles/80211_block_acknowledgment_request_frame.pcap");
                dev.Open();
                ...
                Assert.AreEqual(FrameControlField.FrameSubTypes.ControlBlockAcknowledgmentRequest,
                    frame.FrameControl.SubType);
                ...
                Assert.AreEqual(BlockAcknowledgmentControlField.AcknowledgementPolicy.Delayed,
                    frame.BlockAcknowledgmentControl.Policy);
            ...
            {
                BlockAcknowledgmentRequestFrame frame = new BlockAcknowledgmentRequestFrame(
                    PhysicalAddress.Parse("111111111111"),
                ...
                BlockAcknowledgmentRequestFrame recreatedFrame =
                    MacFrame.ParsePacket(bas) as BlockAcknowledgmentRequestFrame;
            ...
            public void Test_ConstructorWithCorruptBuffer()
            {
                ...
                BlockAcknowledgmentRequestFrame frame =
                    new BlockAcknowledgmentRequestFrame(new ByteArraySegment(corruptBuffer));
