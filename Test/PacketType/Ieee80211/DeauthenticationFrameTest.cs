...
namespace Test.PacketType.Ieee80211;
    ...
    public class DeauthenticationFrameTest
    {
        ...
        {
            var dev = new CaptureFileReaderDevice(NUnitSetupClass.CaptureDirectory + "80211_deauthentication_frame.pcap");
            dev.Open();
            PacketCapture c;
            ...
            var frame = (DeauthenticationFrame) p.PayloadPacket;

            ClassicAssert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            ClassicAssert.AreEqual(FrameControlField.FrameSubTypes.ManagementDeauthentication, frame.FrameControl.SubType);
            ...
            ClassicAssert.AreEqual(1312, frame.SequenceControl.SequenceNumber);
            ClassicAssert.AreEqual(ReasonCode.LeavingToRoam, frame.Reason);

            ClassicAssert.AreEqual(0xDD0A5D6B, frame.FrameCheckSequence);
        ...
        {
            var frame = new DeauthenticationFrame(PhysicalAddress.Parse("111111111111"),
            ...
            var recreatedFrame = MacFrame.ParsePacket(byteArraySegment) as DeauthenticationFrame;
            recreatedFrame.UpdateFrameCheckSequence();

            ClassicAssert.AreEqual(FrameControlField.FrameSubTypes.ManagementDeauthentication, recreatedFrame.FrameControl.SubType);
        ...
        public void Test_ConstructorWithCorruptBuffer()
        {
            ...
            var frame = new DeauthenticationFrame(new ByteArraySegment(corruptBuffer));
