    ...
    namespace Ieee80211
    {
        ...
        public class InformationElementListTest
        {
            ...
            public void Test_FindById_ElementNotPresent()
            {
                ...
                InformationElement[] infoElements =
                    beaconFrame.InformationElements.FindById(InformationElement.ElementId.ChallengeText);
            ...
            public void Test_FindById_FindRepeatedElement()
            {
                ...
                InformationElement[] infoElements =
                    beaconFrame.InformationElements.FindById(InformationElement.ElementId.VendorSpecific);
            ...
            public void Test_FindFirstById_ElementNotPresent()
            {
                ...
                InformationElement infoElement =
                    beaconFrame.InformationElements.FindFirstById(InformationElement.ElementId.ChallengeText);
            ...
            public void Test_FindFirstById_FindElement()
            {
                ...
                InformationElement infoElement =
                    beaconFrame.InformationElements.FindFirstById(InformationElement.ElementId.DsParameterSet);
