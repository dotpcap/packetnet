...
namespace Test.PacketType.Ieee80211
{
    ...
    public class RadioTapFieldsTest
    {
        ...
        {
            ChannelRadioTapField field =
                new ChannelRadioTapField(2142, RadioTapChannelFlags.Channel2Ghz | RadioTapChannelFlags.Ofdm);
        ...
        public void Test_DbAntennaNoiseRadioTapField()
        {
            ...
            DbAntennaNoiseRadioTapField recreatedField =
                new DbAntennaNoiseRadioTapField(new BinaryReader(new MemoryStream(bytes)));
        ...
        public void Test_DbAntennaSignalRadioTapField()
        {
            ...
            DbAntennaSignalRadioTapField recreatedField =
                new DbAntennaSignalRadioTapField(new BinaryReader(new MemoryStream(bytes)));
        ...
        public void Test_DbmAntennaNoiseRadioTapField()
        {
            ...
            DbmAntennaNoiseRadioTapField recreatedField =
                new DbmAntennaNoiseRadioTapField(new BinaryReader(new MemoryStream(bytes)));
        ...
        public void Test_DbmAntennaSignalRadioTapField()
        {
            ...
            DbmAntennaSignalRadioTapField recreatedField =
                new DbmAntennaSignalRadioTapField(new BinaryReader(new MemoryStream(bytes)));
        ...
        public void Test_DbmTxPowerRadioTapField()
        {
            ...
            DbmTxPowerRadioTapField recreatedField =
                new DbmTxPowerRadioTapField(new BinaryReader(new MemoryStream(bytes)));
        ...
        public void Test_DbTxAttenuationRadioTapField()
        {
            ...
            DbTxAttenuationRadioTapField recreatedField =
                new DbTxAttenuationRadioTapField(new BinaryReader(new MemoryStream(bytes)));
        ...
        public void Test_LockQualityRadioTapField()
        {
            ...
            LockQualityRadioTapField recreatedField =
                new LockQualityRadioTapField(new BinaryReader(new MemoryStream(bytes)));
        ...
        public void Test_TxAttenuationRadioTapField()
        {
            ...
            TxAttenuationRadioTapField recreatedField =
                new TxAttenuationRadioTapField(new BinaryReader(new MemoryStream(bytes)));
