...
{
    [TestFixture]
    class Ieee80211AssociationResponseFrameTest
    {
        /// <summary>
        ...
        public void Test_Constructor()
        {
            ...
            Ieee80211AssociationResponseFrame frame = (Ieee80211AssociationResponseFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.ManagementAssociationResponse, frame.FrameControl.Type);
