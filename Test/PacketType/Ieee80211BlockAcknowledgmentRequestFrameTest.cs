...
{
    [TestFixture]
    class Ieee80211BlockAcknowledgmentRequestFrameTest
    {
        /// <summary>
        ...
        public void Test_Constructor()
        {
            ...
            Ieee80211BlockAcknowledgmentRequestFrame frame = (Ieee80211BlockAcknowledgmentRequestFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.ControlBlockAcknowledgmentRequest, frame.FrameControl.Type);
