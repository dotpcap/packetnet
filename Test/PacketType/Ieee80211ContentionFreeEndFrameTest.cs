...
{
    [TestFixture]
    class Ieee80211ContentionFreeEndFrameTest
    {
        /// <summary>
        ...
        public void Test_Constructor()
        {
            ...
            Ieee80211ContentionFreeEndFrame frame = (Ieee80211ContentionFreeEndFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.ControlCFEnd, frame.FrameControl.Type);
