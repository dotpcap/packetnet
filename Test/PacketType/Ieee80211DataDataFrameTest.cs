...
{
    [TestFixture]
    class Ieee80211DataDataFrameTest
    {
        /// <summary>
        ...
        public void Test_Constructor_UnencryptedDataFrame()
        {
            ...
            Ieee80211DataDataFrame frame = (Ieee80211DataDataFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.Data, frame.FrameControl.Type);
