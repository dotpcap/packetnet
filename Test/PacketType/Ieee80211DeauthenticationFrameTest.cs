...
{
    [TestFixture]
    class Ieee80211DeauthenticationFrameTest
    {
        /// <summary>
        ...
        public void Test_Constructor()
        {
            ...
            Ieee80211DeauthenticationFrame frame = (Ieee80211DeauthenticationFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.ManagementDeauthentication, frame.FrameControl.Type);
