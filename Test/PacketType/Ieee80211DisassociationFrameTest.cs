...
{
    [TestFixture]
    class Ieee80211DisassociationFrameTest
    {
        /// <summary>
        ...
        public void Test_Constructor()
        {
            ...
            Ieee80211DisassociationFrame frame = (Ieee80211DisassociationFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.ManagementDisassociation, frame.FrameControl.Type);
