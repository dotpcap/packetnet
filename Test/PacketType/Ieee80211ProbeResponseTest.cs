...
{
    [TestFixture]
    class Ieee80211ProbeResponseTest
    {
        /// <summary>
        ...
        public void Test_Constructor()
        {
            ...
            Ieee80211ProbeResponseFrame frame = (Ieee80211ProbeResponseFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.ManagementProbeResponse, frame.FrameControl.Type);
