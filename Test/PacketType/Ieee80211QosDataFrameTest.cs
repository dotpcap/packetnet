...
{
    [TestFixture]
    class Ieee80211QosDataFrameTest
    {
        /// <summary>
        ...
        public void Test_Constructor()
        {
            ...
            Ieee80211QosDataFrame frame = (Ieee80211QosDataFrame)p.PayloadPacket;

            Assert.AreEqual(0, frame.FrameControl.ProtocolVersion);
            Assert.AreEqual(Ieee80211FrameControlField.FrameTypes.QosData, frame.FrameControl.Type);
