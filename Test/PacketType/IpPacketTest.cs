    ...
    public class IpPacketTest
    {
        ...
        public void BinarySerialization()
        {
            ...
            while ((rawCapture = dev.GetNextPacket()) != null)
            {
                ...
                Assert.AreEqual(ip.BytesHighPerformance.NeedsCopyForActualBytes,
        ...
        public void IpPacket_WhenGettingPacketFragment_LeavesPacketAsPayload()
        {
            ...
            Assert.IsNull(ipFragmentPacket.PayloadPacket,
                "Since packet is IP fragment, we should not have extracted a child packet");
            Assert.AreEqual(497, ipFragmentPacket.PayloadLength,
                "The correct payload length for this particular packet should be 497");
            Assert.AreEqual(497, ipFragmentPacket.PayloadData.Length,
                "The correct payload length for this particular packet should be 497");
        }
